...
const INT_IMAGES = {
  "bugatti-chiron": BugattiInt,
  "ferrari-roma": FerrariInt,
  "pagani-huayra": PaganiInt,
  "rolls-royce-phantom": RollsInt,
  "toyota-supra-mk5": SupraInt,
  "koenigsegg-regera": KoenigInt,
  "lamborghini-veneno": LamboInt,
  "aston-martin-valkyrie": AstonInt,
...
const CONFIG = {
  colors: [
    { n: "Noir Obsidian", p: 0, hex: "#0a0a0a" },
    { n: "Arctic White", p: 12000, hex: "#f0ece4" },
    { n: "Racing Red", p: 8000, hex: "#8b0000" },
    { n: "Midnight Blue", p: 8000, hex: "#0a1628" },
    { n: "Gold Edition", p: 25000, hex: "#b8962e" },
    { n: "Matte Carbon", p: 18000, hex: "#1a1a1a" },
  ],
  interiors: [
    { n: "Black Leather", p: 0 },
    { n: "Cream Nappa", p: 15000 },
    { n: "Red Alcantara", p: 22000 },
    { n: "Carbon Fiber", p: 35000 },
  ],
  performance: [
    { n: "Standard", p: 0, sub: "Base configuration" },
    { n: "Sport Package", p: 45000, sub: "+180 hp" },
    { n: "Track Edition", p: 85000, sub: "+310 hp" },
    { n: "Ultimate", p: 140000, sub: "Maximum output" },
  ],
  wheels: [
    { n: "Standard Alloy", p: 0 },
    { n: "Forged Carbon", p: 18000 },
    { n: "Titanium Sport", p: 28000 },
    { n: "Signature Edition", p: 42000 },
  ],
};
...
const PROCESS_STEPS = [
  {
    ...
    desc: "Browse our curated collection of the world's most exclusive hypercars and grand tourers.",
  },
  {
    num: "02",
    title: "Configure Specifications",
    desc: "Personalise every detail — colour, interior, performance package and bespoke wheel set.",
  },
  {
    num: "03",
    title: "Submit Request",
    desc: "Submit your acquisition request securely through our encrypted platform.",
  },
  {
    num: "04",
    title: "Specialist Contact",
    desc: "A dedicated Luxor Motors specialist will reach you within 24 hours to discuss your order.",
  },
  {
    num: "05",
    title: "Finalise Purchase",
    desc: "Complete your acquisition with full concierge support and white-glove delivery worldwide.",
  },
];
  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${type === "success" ? "rgba(212,175,55,0.5)" : "rgba(200,50,50,0.5)"}`,
        padding: "1.1rem 1.8rem",
        maxWidth: "360px",
        animation: "pmToastIn 0.4s cubic-bezier(0.23,1,0.32,1)",
...
function ConfiguratorModal({ vehicle, onConfirm, onClose }) {
  ...
  const handleBuy = async () => {
    ...
    await onConfirm({
      ...
      price: vehicle.valuation,
      color: CONFIG.colors[colorIdx].n,
      interior: CONFIG.interiors[interIdx].n,
      performance: CONFIG.performance[perfIdx].n,
      wheels: CONFIG.wheels[wheelIdx].n,
      total_price: total,
    });
    setLoading(false);
  };
      ...
      >
        ...
        >
          {cfgTabs.map((t) => (
            <button
              ...
              className={`cfg-tab-new ${cfgTab === t.key ? "active" : ""}`}
            >
              <span
                style={{
                  fontSize: "0.72rem",
        ...
        <div style={{ flex: 1, padding: "2rem 2.4rem", overflowY: "auto" }}>
          ...
          >
            ...
            >
              {cfgTab === "color" && CONFIG.colors[colorIdx].n}
              {cfgTab === "interior" && CONFIG.interiors[interIdx].n}
              {cfgTab === "performance" && CONFIG.performance[perfIdx].n}
              {cfgTab === "wheels" && CONFIG.wheels[wheelIdx].n}
            </div>
            {currentAddon > 0 ?
              <div
                style={{
              ...
              >
                {CONFIG.colors.map((c, i) => (
                  <div
                    ...
                    className={`cfg-swatch-new ${colorIdx === i ? "active" : ""}`}
                    title={c.n}
                    style={{
                      background: c.hex,
                      boxShadow:
                        colorIdx === i ?
                          `0 0 0 1px ${GOLD}, 0 6px 20px ${c.hex}50`
                        : "none",
                    }}
                  />
                ))}
              ...
              >
                {CONFIG.colors.map((c, i) => (
                  <button
                    key={i}
                    onClick={() => setColorIdx(i)}
                    className={`cfg-option-row ${colorIdx === i ? "active" : ""}`}
                  >
                    <div
                      style={{
                        display: "flex",
                    ...
                    <span
                      style={{
                        fontFamily: F.tenor,
                        fontSize: "0.72rem",
                        color: colorIdx === i ? GOLD : "rgba(255,255,255,0.18)",
                        transition: "color 0.3s",
                      }}
                    >
                      {c.p > 0 ? `+${fmt(c.p)}` : "Included"}
                    </span>
                  </button>
                ))}
              </div>
            ...
            <div style={{ animation: "cfgSlideIn 0.28s ease" }}>
              ...
              >
                {CONFIG.interiors.map((c, i) => (
                  <button
                    key={i}
                    onClick={() => setInterIdx(i)}
                    className={`cfg-option-row ${interIdx === i ? "active" : ""}`}
                  >
                    <span
                      style={{
                        fontFamily: F.sans,
                    ...
                    <span
                      style={{
                        fontFamily: F.tenor,
                        fontSize: "0.72rem",
                        color: interIdx === i ? GOLD : "rgba(255,255,255,0.18)",
                        transition: "color 0.3s",
                      }}
                    >
                      {c.p > 0 ? `+${fmt(c.p)}` : "Included"}
            ...
            <div style={{ animation: "cfgSlideIn 0.28s ease" }}>
              ...
              >
                {CONFIG.performance.map((c, i) => (
                  <button
                    key={i}
                    onClick={() => setPerfIdx(i)}
                    className={`cfg-option-row ${perfIdx === i ? "active" : ""}`}
                    style={{
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontFamily: F.tenor,
                        fontSize: "0.82rem",
                        color: perfIdx === i ? GOLD : "rgba(255,255,255,0.18)",
                        transition: "color 0.3s",
                        flexShrink: 0,
                      }}
                    >
              ...
              >
                {CONFIG.wheels.map((c, i) => (
                  <button
                    ...
                    className={`cfg-option-row ${wheelIdx === i ? "active" : ""}`}
                  >
                    <span
                      style={{
                        fontFamily: F.sans,
                    ...
                    <span
                      style={{
                        fontFamily: F.tenor,
                        fontSize: "0.72rem",
                        color: wheelIdx === i ? GOLD : "rgba(255,255,255,0.18)",
                        transition: "color 0.3s",
                      }}
                    >
                      {c.p > 0 ? `+${fmt(c.p)}` : "Included"}
        ...
        >
          ...
          >
            {[
              { label: "Base Price", val: base, skip: false },
              {
                label: CONFIG.colors[colorIdx].n,
                val: CONFIG.colors[colorIdx].p,
                skip: CONFIG.colors[colorIdx].p === 0,
              },
              {
                label: CONFIG.interiors[interIdx].n,
                val: CONFIG.interiors[interIdx].p,
                skip: CONFIG.interiors[interIdx].p === 0,
              },
              {
                label: CONFIG.performance[perfIdx].n,
                val: CONFIG.performance[perfIdx].p,
                skip: CONFIG.performance[perfIdx].p === 0,
              },
              {
                label: CONFIG.wheels[wheelIdx].n,
                val: CONFIG.wheels[wheelIdx].p,
                skip: CONFIG.wheels[wheelIdx].p === 0,
              },
            ]
              .filter((x) => !x.skip)
              .map(({ label, val }) => (
          ...
          >
            ...
            >
              <div>VAT Exclusive</div>
              <div>White-Glove Delivery</div>
              <div>24h Specialist Contact</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", gap: "0.55rem" }}>
            ...
            <button
              ...
              style={{
                ...
                color: loading ? "rgba(212,175,55,0.3)" : GOLD,
                fontFamily: F.sans,
                fontSize: "0.4rem",
            ...
            >
              {loading ?
                ...
                >
                  <span style={{ animation: "cfgPulse 1s infinite" }}>◆</span>
  ...
  return (
    <div
      ...
      style={{
        ...
        animation: `pmFadeUp 0.5s ease ${index * 0.06}s both`,
      }}
    >
      ...
      <div style={{ padding: "1.7rem 1.7rem 1.5rem" }}>
        ...
        >
          <span
            style={{ fontFamily: F.tenor, fontSize: "1.2rem", color: GOLD }}
          >
            {vehicle.valuation}
          </span>
          <span
            style={{
              ...
              letterSpacing: "0.2em",
              color:
                soldOut ? "rgba(255,255,255,0.18)" : "rgba(212,175,55,0.58)",
              border: `1px solid ${soldOut ? "rgba(255,255,255,0.06)" : "rgba(212,175,55,0.16)"}`,
        ...
        <button
          onClick={() => !soldOut && onConfigure(vehicle)}
          disabled={soldOut}
          style={{
            width: "100%",
            padding: "0.85rem",
            background: "transparent",
            border: `1px solid ${soldOut ? "rgba(255,255,255,0.04)" : "rgba(212,175,55,0.2)"}`,
            color: soldOut ? "rgba(255,255,255,0.1)" : "rgba(212,175,55,0.72)",
            fontFamily: F.sans,
            fontSize: "0.44rem",
        ...
        {PROCESS_STEPS.map((step, i) => (
          <div
            ...
            style={{
              ...
              flexDirection: "column",
              gap: "0.9rem",
              animation: `pmFadeUp 0.5s ease ${i * 0.08}s both`,
            }}
          >
            <div
              style={{
        ...
        >
          <div>
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontSize: "0.37rem",
                  letterSpacing: "0.3em",
                  color: "rgba(80,210,80,0.68)",
                  border: "1px solid rgba(80,210,80,0.16)",
            ...
            >
              {[
                { l: "Colour", v: o.color },
                { l: "Interior", v: o.interior },
                { l: "Performance", v: o.performance },
                { l: "Wheels", v: o.wheels },
              ].map(
                ({ l, v }) =>
                  v && (
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.background = "rgba(200,60,60,0.07)")
              }
              onMouseLeave={(e) =>
...
function InventoryTab({ vehicles, onStockChange }) {
  ...
  const save = async (slug) => {
    const n = changes[slug];
    if (n === undefined) return;
    setSaving(true);
    await onStockChange(slug, n);
    setChanges((p) => {
      const c = { ...p };
      delete c[slug];
      return c;
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
        {vehicles.map((v) => {
          const n = parseInt(v.stock) || 0;
          const hp = changes[v.slug] !== undefined;
          return (
            <div
              key={v.slug}
              style={{
            ...
            >
              <div>
                ...
                <div
                  style={{
                    ...
                    fontSize: "0.39rem",
                    color:
                      n === 0 ? "rgba(210,80,80,0.58)" : "rgba(80,210,80,0.58)",
                    marginTop: "4px",
                    letterSpacing: "0.2em",
                  }}
                >
                  {n === 0 ? "SOLD OUT" : `${n} in stock`}
                </div>
              </div>
              <input
                type="number"
              ...
              <button
                ...
                style={{
                  ...
                  background: hp ? "rgba(212,175,55,0.08)" : "transparent",
                  border: `1px solid ${hp ? "rgba(212,175,55,0.42)" : "rgba(255,255,255,0.05)"}`,
                  color: hp ? GOLD : "rgba(255,255,255,0.1)",
                  fontFamily: F.sans,
                  fontSize: "0.41rem",
                  letterSpacing: "0.2em",
                  textTransform: "uppercase",
                  cursor: hp ? "pointer" : "not-allowed",
                }}
              >
                Save
              </button>
...
function AdminPanel({ vehicles, onRefresh, notify }) {
  ...
  const handleDelete = async (slug, model) => {
    if (!window.confirm(`Delete ${model}?`)) return;
    try {
      const r = await fetch(`${API}/vehicles/${slug}`, { method: "DELETE" });
  ...
  const handleSubmit = async () => {
    if (!form.slug || !form.model)
      return notify("Slug and model required", "error");
    setSaving(true);
    try {
      const ie = view === "edit";
      const r = await fetch(
        ie ? `${API}/vehicles/${editSlug}` : `${API}/vehicles`,
        {
          method: ie ? "PUT" : "POST",
      ...
      notify(ie ? `${form.model} updated` : `${form.model} added`);
      onRefresh();
      setForm(empty);
      setView("list");
    } catch (e) {
  ...
  const Field = ({ label, field, placeholder, area }) => (
    <div>
  ...
  const subBtn = (key, label, onClick) => {
    const a = view === key || (view === "edit" && key === "list");
    return (
      <button
        onClick={onClick || (() => setView(key))}
        style={{
          padding: "0.7rem 1.5rem",
          background: a ? "rgba(212,175,55,0.05)" : "transparent",
          border: "none",
          borderBottom: a ? `1px solid ${GOLD}` : "1px solid transparent",
          color: a ? GOLD : "rgba(255,255,255,0.28)",
          fontFamily: F.sans,
          fontSize: "0.44rem",
          letterSpacing: "0.25em",
          textTransform: "uppercase",
  ...
  return (
    <div>
      ...
      >
        ...
        {subBtn("add", "+ Add Vehicle", () => {
          setForm(empty);
          setView("add");
        })}
        {subBtn("orders", "All Orders", () => {
          setView("orders");
          loadOrders();
        })}
      </div>
      {(view === "list" || view === "edit") && (
        <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
          {vehicles.map((v) => {
            const ie = view === "edit" && editSlug === v.slug;
            const n = parseInt(v.stock) || 0;
            return (
              <div key={v.slug}>
                <div
                  style={{
                    ...
                    alignItems: "center",
                    padding: "1rem 1.4rem",
                    background: ie ? "rgba(212,175,55,0.025)" : "#060606",
                    border: `1px solid ${ie ? "rgba(212,175,55,0.22)" : "rgba(255,255,255,0.04)"}`,
                    transition: "all 0.3s",
                  }}
                >
                  <div>
                  ...
                  <div style={{ display: "flex", gap: "0.5rem" }}>
                    ...
                    <button
                      onClick={() => handleDelete(v.slug, v.model)}
                      style={{
                        padding: "0.42rem 0.9rem",
                        background: "transparent",
                        border: "1px solid rgba(200,50,50,0.22)",
                        color: "rgba(210,90,90,0.62)",
                        fontFamily: F.sans,
                        fontSize: "0.41rem",
                        letterSpacing: "0.14em",
                        textTransform: "uppercase",
                ...
                <div style={{ textAlign: "right" }}>
                  <span
                    style={{
                      ...
                      fontSize: "0.37rem",
                      letterSpacing: "0.2em",
                      color: "rgba(80,210,80,0.62)",
                      border: "1px solid rgba(80,210,80,0.14)",
...
export default function PurchaseMenu() {
  ...
  useEffect(() => {
    if (tab === "orders" || tab === "inventory") fetchOrders();
  }, [tab, fetchOrders]);
  ...
  const handleStock = async (slug, qty) => {
    ...
    try {
      const r = await fetch(`${API}/vehicles/${slug}/stock`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
    ...
    >
      ...
      <div
        style={{
          ...
          textAlign: "center",
          background:
            "radial-gradient(ellipse at top,rgba(212,175,55,0.05) 0%,transparent 55%)",
          position: "relative",
        }}
      >
        <div
        ...
        <div
          style={{
            ...
            textTransform: "uppercase",
            marginBottom: "1.3rem",
            animation: "pmFadeUp 0.8s ease 0.1s both",
          }}
        >
        ...
        <h2
          style={{
            ...
            lineHeight: 1,
            marginBottom: "1.5rem",
            animation: "pmFadeUp 0.9s ease 0.22s both",
          }}
        >
          Acquisition Portal
        </h2>
        <div
          style={{
            ...
            width: "0",
            animation:
              "pmLineIn 1.2s cubic-bezier(0.23,1,0.32,1) 0.45s forwards",
            maxWidth: "120px",
          }}
        />
        <p
          style={{
            ...
            letterSpacing: "0.18em",
            marginTop: "1.8rem",
            animation: "pmFadeUp 0.8s ease 0.5s both",
            fontWeight: 300,
          }}
        >
          Configure, personalise and acquire the world's finest automobiles
        </p>
      </div>
      ...
      <div style={{ maxWidth: "1340px", margin: "0 auto", padding: "0 60px" }}>
        {tab === "fleet" && (
          <div>
            ...
            >
              Select a vehicle to begin your configuration
            </p>
            <div
              style={{
                display: "grid",
        ...
        {tab === "inventory" && (
          <InventoryTab vehicles={vehicles} onStockChange={handleStock} />
        )}
        {tab === "admin" && (
          <AdminPanel
            vehicles={vehicles}
