...
*/
import "./TabButtonStockDefinition.css";
...
/*
 Definimos y exportamos el componente funcional TabButton.
...
*/
export default function TabButtonStockDefinition({ children, onSelect }) {
  /*
   children:
